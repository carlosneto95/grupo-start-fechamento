...
considerada ou não, categoria) — de todas as empresas. A partir daí:
  ...
  - os ajustes manuais daquele mês ficam travados (app/trava_fechamento.py);
...
from app.dinheiro import ZERO, para_centavos, para_reais
from app.escopo import SISTEMA, clausula, exigir_admin
