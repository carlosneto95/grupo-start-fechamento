...
from app import seguranca, usuarios, validacao
...
def login():
    ...
    if request.method == "POST":
        ...
        if usuario is not None:
            ...
            # Só caminho interno: um ?proximo=https://site-falso vira "/".
            destino = seguranca.destino_seguro(
                request.args.get("proximo"), url_for("despesas.listar")
            )
