"""Roda o job único de sincronização (app/sincronizar_tudo.py) em segundo
...
linha de comando × tarefa agendada) é a do banco, em app/trava.py.
"""
...
from app import sincronizacao, sincronizar_tudo
