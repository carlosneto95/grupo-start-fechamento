...
from financeiro import configuracao, db, pendencias, registro, seguranca
...
def criar_app(sobrescrever: dict | None = None) -> Flask:
    ...
    def _contexto():
        ...
        # conforto: a trava é o decorador na rota (financeiro/seguranca.py).
        escopo = g.get("escopo")
        return {
            "escopo": escopo,
...
def _registrar_filtros(app: Flask) -> None:
    from financeiro.visao import formatar_valor
