...
# Tipos das colunas dos quadros de resultado (ver financeiro/centros_de_custo.py),
...
def arvore_de_gastos(
    contas: list[dict], niveis=("categoria_primaria", "subcategoria", "fornecedor")
) -> dict:
